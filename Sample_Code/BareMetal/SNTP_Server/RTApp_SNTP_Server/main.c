...
static const ComponentId hlAppId = { .data1 = 0x0194a35c,
                                    .data2 = 0x6048,
                                    .data3 = 0x40dc,
                                    .data4 = {0xaa, 0x3c, 0x37, 0x1a, 0x79, 0xb0, 0x35, 0x60} };
...
_Noreturn void RTCoreMain(void)
{
    ...
    printf("-------------------------------------------\r\n");
    printf(" ASG200_SNTP_Server_RTApp_MT3620_BareMetal \r\n");
    ...
    /* Init SNTP */
    SNTPs_init(0, gDATABUF); // sock 0 open as SNTP server
